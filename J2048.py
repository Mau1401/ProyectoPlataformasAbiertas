...
def main(fromLoaded = False, board_size = 4):
	global BOARD_SIZE 
	global tileMatrix
	BOARD_SIZE = board_size
	SURFACE = pygame.display.set_mode((500, 500), 0, 32) #para que se modifique y se acomple al tamano los cuadros.
...
def printGameOver():
	...
	label2 = scorefont.render("Score:" + str(TOTAL_POINTS), 1, (255,255,255))
	label3 = myfont.render("Press r to restart o la tecla esc para salir", 1, (255,255,255))
...
def createEmptyMatrix():
	return [[0 for i in range(0, BOARD_SIZE)] for j in range(0, BOARD_SIZE)]
